"""Generate a classic 6-color pride flag hex grid data file, masked by transparent regions in the map image."""
...
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "maps", "pride.json")

# Classic pride flag bands (top to bottom): red, orange, yellow, green, blue, purple
# Mapped to palette indices in main.py
BANDS = [1, 5, 4, 2, 3, 6]  # red, orange, yellow, green, blue, purple
...
print(f"Pride flag saved to {OUTPUT_PATH}")
